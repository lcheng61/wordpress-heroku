...
<html lang="en">
 			...
 			<div class="row">
				<div class="col-lg-7 col-lg-offset-5 col-md-8 col-md-offset-4 col-sm-10 col-sm-offset-1 col-xs-12">
					<div class="cont-wrapper">
						<p class="intro">Beachstrap, is a new bootstrap theme, packed full of features and responsive goodness</p>
	...
	<div id="intro-strip">
		<div class="container">
			<div class="row">
				<div class="col-lg-8 col-lg-offset-2"><h1>Full responsive design, CSS3 animations fully customisable</h1></div>
			</div><!-- end row -->
		</div><!-- end container -->
	</div><!-- end intro strip -->
...
<div id="home">
	...
	<div class="row">
		<div class="col-lg-7 col-md-7 col-sm-7 col-xs-12  text">
			...
			<p><strong>Full responsive design, css3 animationsfully customisable</strong></p>
			<p class="btn-wrp"><a class="c2a-button">Call to action</a></p>
		</div>
		<div class="col-lg-5 col-md-5 col-sm-5 ipad hidden-xs">
			<img src="images/ipadShot.jpg" class="img-responsive" alt="ipadShot" />
		</div>
		...
		<div class="container">
	 		 <div class="row">
	 		 	<div class="col-lg-8 col-lg-offset-2">
			 		<h2>Parallax backgrounds for an ultra modern web experience!</h2>
	 		 	</div>
	 		 </div>
		 </div>
	</div>
	...
	<div class="container">
		...
		<div class="row">
			<div class="col-lg-3 col-md-3 col-sm-3">
				<div class="staff-mem">
					<img data-src="holder.js/210x210" class="img-responsive img-circle">
					<h3>John Doe</h3>
...
<div class="container">
	...
	<div class="row">
		<div class="col-lg-4 col-md-4 col-sm-4 post">
				...
				<div class="post-pic">
					<img data-src="holder.js/370x240" class="img-responsive">
				</div>
